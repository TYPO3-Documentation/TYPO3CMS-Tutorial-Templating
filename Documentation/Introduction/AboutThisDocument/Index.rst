...
You need an installed version of TYPO3 4.6 or higher. We recommanded the "Blank Package" as a basis. It is downloadable from `here: <http://typo3.org/download/packages/>`_.
...
You are a beginner as a site developer. This tutorial contains step by step instructions, which enable you to create your first website with TYPO3, based on a given HTML file.
