...
Now, let´s go through the steps for creating the page structure. The screenshots are from the 
´Introduction Package <http://docs.typo3.org/typo3cms/GettingStartedTutorial/Index.html>´_. 
...
In the TYPO3 backend make sure you are in the Page module by first opening the "Web" section
on the left side of the Backend and then clicking on the "Page" module underneath. This will open the page tree of your 
TYPO3 installation.

.. figure:: ../../Images/TBT-page-module.jpg
   :alt: The Page Module

Create a first page, which is hierarchically located directly below the TYPO3
...
(note: this is not the same as TYPO3´s context pop-up menu). Give the page the title "Root".
...
A TYPO3 pop-up menu will appear in a new window in your browser.
