...
please also see [Site Package Tutorial](https://docs.typo3.org/typo3cms/SitePackageTutorial/)
...
* In order to make changes on a [rendered page](https://docs.typo3.org/typo3cms/TemplatingTutorial/), just click on "Edit me on GitHub".
